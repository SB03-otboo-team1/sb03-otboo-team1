...
public class ClothesServiceImpl implements ClothesService {
    ...
    public CursorPageResponseDto<ClothesDto> getClothesWithCursor(UUID ownerId, String cursor,
        UUID idAfter, int limit, SortBy sortBy, SortDirection sortDirection,
        ClothesType typeEqual) {

        List<Clothes> clothes =
            clothesRepository.getClothesWithCursor(ownerId, cursor, idAfter, limit, sortBy,
                sortDirection, typeEqual);
        ...
        if (hasNext) {
            ...
            switch (sortBy) {
                case CREATED_AT -> nextCursor = lastClothes.getCreatedAt().toString();
                case NAME -> nextCursor = lastClothes.getName();
            }
    ...
    @Override
    public ClothesDto updateClothes(UUID clothesId, ClothesUpdateRequest request,
